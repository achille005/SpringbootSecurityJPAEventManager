...
import com.achille.spring.dto.UserDetailsImpl;
import com.achille.spring.dto.UserEditForm;
import com.achille.spring.entities.User;
import com.achille.spring.entities.User.Role;
...
public class UserServiceImpl implements UserService, UserDetailsService {
	...
	public void resetPassword(String forgotPasswordCode,
		...
		Optional<User> optionalUser = userRepository.findByForgotPasswordCode(forgotPasswordCode);
